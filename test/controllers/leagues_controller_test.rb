...
class LeaguesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create league" do
    assert_difference('League.count') do
      post leagues_url, params: { league: { name: @league.name, team_limit: @league.team_limit, zip: @league.zip } }
    end
  ...
  test "should update league" do
    patch league_url(@league), params: { league: { name: @league.name, team_limit: @league.team_limit, zip: @league.zip } }
